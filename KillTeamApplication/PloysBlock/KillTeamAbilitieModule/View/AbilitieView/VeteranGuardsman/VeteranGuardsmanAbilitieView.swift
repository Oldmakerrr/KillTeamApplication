...
class VeteranGuardsmanAbilitieView: KillTeamAbilitieView {
    ...
    func setupAbilitie(abilitie: VeteranGuardsmanAbilitie, viewController: UIViewController) {
    ...
    private func setupAncillarySupport(ancillarySupport: VeteranGuardsmanAbilitie.AncillarySupport) {
