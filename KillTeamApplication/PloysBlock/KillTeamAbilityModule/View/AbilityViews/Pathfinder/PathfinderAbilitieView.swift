...
class PathfinderAbilitieView: KillTeamAbilitieView {
    ...
    func setupAbilitieText(abilitie: PathfinderAbility.Abilitie) {
    ...
    func setupMarkerlightRule(markerRule: PathfinderAbility.MarkerlightRule, delegate: WeaponRuleButtonDelegate) {
    ...
    func setupArtOfWarRule(artOfWarRule: PathfinderAbility.ArtOfWarRule) {
    ...
    private func setupUniqueActionView(markerRule: PathfinderAbility.MarkerlightRule, delegate: WeaponRuleButtonDelegate) {
        let backgroundView = UIView()
...
class ArtOfWarView: UIStackView {
    ...
    func setupText(abilitie: PathfinderAbility.Abilitie) {
        setupHeader(title: abilitie.name)
        abilitie.rules.forEach { text in
            setupTextView(text: text)
        }
