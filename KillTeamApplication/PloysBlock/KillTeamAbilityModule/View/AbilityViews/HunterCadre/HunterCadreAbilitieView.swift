...
class HunterCadreAbilitieView: KillTeamAbilitieView {
    ...
    func setupDroneRule(abilitie: HunterCadreAbility) {
    ...
    func setupUniqueAction(action: HunterCadreAbility.UniqueAction) {
    ...
    func setupAbiliteRule(abilitie: HunterCadreAbility.Abilitie) {
