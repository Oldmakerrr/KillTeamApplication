...
class BoonOfTzeenchTableViewController: UITableViewController {
    ...
    var boonsOfTzeentch: [[WarpcovenAbility.BoonsOfTzeentch]]?
    ...
    func addBoonOfTzeench(abilitie: WarpcovenAbility) {
        var boonsOfTzeentch = [[WarpcovenAbility.BoonsOfTzeentch]]()
        var mutation = [WarpcovenAbility.BoonsOfTzeentch]()
        var fate = [WarpcovenAbility.BoonsOfTzeentch]()
        var aetheric = [WarpcovenAbility.BoonsOfTzeentch]()
...
class BoonOfTzeenchTableViewCell: KillTeamAbilitieTableViewCell<AbilitieView> {
    func setupText(abilitie: WarpcovenAbility.BoonsOfTzeentch) {
